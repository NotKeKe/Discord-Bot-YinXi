...
class Tool:
    async def call(self, keywords: str, time_range: str | None = 'year', language: str = 'zh-TW') -> str:
        result = []
        ...
        async def scrape_page(session: ClientSession, url: str) -> tuple[str | None, str | None, str | None]:
            try:
        ...
        for title, content, url in task_results:
            if title is None or content is None: continue
